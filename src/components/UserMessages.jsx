...
export default function UserMessages() {
    ...
    return (
        <div className="user-message">
            <Snackbar anchorOrigin={{ vertical: 'top', horizontal: 'center'}} open={alertEdit} autoHideDuration={6000} onClose={() => setAlertEdit(false)}>
                <MuiAlert onClose={() => setAlertEdit(false)} severity="info" elevation={6} variant="filled" >
                    Spatial was saved successfully
                </MuiAlert>
            </Snackbar>
            <Snackbar anchorOrigin={{ vertical: 'top', horizontal: 'center'}} open={alertDelete} autoHideDuration={6000} onClose={() => setAlertDelete(false)}>
